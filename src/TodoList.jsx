...
const TodoList = () => {
  ...
  return (
    <div id="todoListPage" className="bg-half">
      <nav>
        <a href="#">
          <img className="logoImg" src="https://raw.githubusercontent.com/jesswu1551/react_todo/main/src/assets/logo.png" alt="logoImg" />
        </a>
        <h1>
      ...
      <div className="container todoListPage vhContainer">
        <div className="todoList_Content">
          <div className="inputBox">
            ...
            >
              <img src="/react_api_todolist/plus.png" alt="plus" />
            </a>
          </div>
                ...
                {filterTodos.map((todo) => {
                  return (
                    <li key={todo.id}>
                      ...
                      >
                        <img src="/react_api_todolist/delete.jpg" alt="delete" />
                      </a>
                    </li>
                  );
                })}
